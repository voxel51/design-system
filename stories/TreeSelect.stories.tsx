...
function ControlledTreeSelect(props: any) {
  const [value, setValue] = useState<TreePath | undefined>(props.value);
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function ControlledMultiTreeSelect(props: any) {
  const [values, setValues] = useState<TreePath[]>(props.value ?? []);
