...
// Figma has no contrast-text token, and the `action-*-text` ones this used to
// read were invented in code. Every filled MUI palette color here resolves to
// a mode-independent fill, so a literal is correct in both themes.
