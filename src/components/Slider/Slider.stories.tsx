...
const singleKnobProps: Story = {
  ...
  render: (props) => {
    ...
    return <SingleValueSlider {...props} value={value} onChange={onChange} />;
  },
};

const multiKnobProps: Story = {
  args: {
  ...
  render: (props) => {
    ...
    return <MultiValueSlider {...props} value={value} onChange={onChange} />;
  },
};
...
export const Controlled: Story = {
  ...
  render: (props) => {
    ...
    return <BaseSlider {...props} value={value} onChange={onChange} />;
  },
};
